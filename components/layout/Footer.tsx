...
import { clinicInfo, navLinks, treatments } from "@/lib/data";
...
export function Footer() {
  ...
  const services = treatments.slice(0, 6);

  return (
    <footer className="bg-[#09221B] text-white pt-16 pb-8">
          ...
          <div>
            <Link href="/" className="inline-block mb-4">
              <span className="font-heading font-bold text-2xl text-white">
                Mantra <span className="text-primary-light">Dental Care</span>
              </span>
            </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href={clinicInfo.socialMedia.youtube}
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/10 p-2 rounded-full hover:bg-primary transition-colors text-white"
                aria-label="Youtube"
